...
// terms of samples) there at least should be, in order to the caller to
...
// Returns a pointer to the beginning of the samples which haven't been output
...
// Ensures that the buffer has enough capacity, IE space for at least
...
void FIFOSampleBuffer::ensureCapacity(uint capacityRequirement)
{
    ...
    {
        // Enlarge the buffer in 4 kilobyte steps (round up to next 4k boundary)
...
// Returns non-zero if the sample buffer is empty
