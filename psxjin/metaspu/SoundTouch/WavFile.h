...
public:
    ...
    // Get number of bits per sample, IE 8 or 16
	
    uint getNumBits() const;

    // Get sample data size in bytes. This should return same information as 
    // 'getBytesPerSample'
    ...
    // Get number of bytes per audio sample (EG 16-bit stereo = 4 bytes/sample)
    ...
    // of elements from the file or if the end of file reached, as many elements as are 
    // left in the file
    ...
    // or if the end of file reached, as many elements as are left in the file
...
private:
    ...
    // data written to file and other data
...
public:
    ...
    WavOutFile(const char *fileName,    // Filename
               int sampleRate,          // Sample rate (EG 44100)
    ...
    // Write data to WAV file. This function works only with 8-bit samples. 
    ...
    // information according to written data and other data
